...
angular.module('angular-google-analytics', [])
    .provider('Analytics', function() {
        ...
        this.$get = ['$document', '$rootScope', '$location', '$window', function($document, $rootScope, $location, $window) {
            ...
            this._trackPage = function(url, title, dimensions) {
                ...
                if (trackRoutes && !analyticsJS && $window._gaq) {
                    ...
                    if (angular.isArray(accountId)) {
                        ...
                        if (!dimensions)
                            dimensions={};
                        dimensions.page = trackPrefix + url;
                        dimensions.title= title;
                        $window.ga('send', 'pageview', dimensions);
                    }
            ...
            return {
                ...
                trackPage: function(url, title, dimensions) {
                    // add a page event
                    me._trackPage(url, title, dimensions);
                },
